  ...
  return `<main class="os-vps-page os-vps-landing">
      ...
      <div class="container">
        ...
        <div class="os-distro-wrap">
          ...
          <div class="os-distro-tabs" role="tablist" aria-labelledby="linux-distro-label">
            <button class="os-distro-tab" id="tab-ubuntu" type="button" role="tab" aria-selected="true" aria-controls="panel-ubuntu"><img src="/assets/os-logos/ubuntu.svg" alt="Ubuntu" width="32" height="32" decoding="async"><span><strong>Ubuntu</strong><small>18.04 / 20.04 / 22.04</small></span></button>
            <button class="os-distro-tab" id="tab-debian" type="button" role="tab" aria-selected="false" aria-controls="panel-debian"><img src="/assets/os-logos/debian.svg" alt="Debian" width="32" height="32" decoding="async"><span><strong>Debian</strong><small>10 / 11</small></span></button>
            <button class="os-distro-tab" id="tab-centos" type="button" role="tab" aria-selected="false" aria-controls="panel-centos"><img src="/assets/os-logos/centos.svg" alt="CentOS" width="32" height="32" decoding="async"><span><strong>CentOS</strong><small>7 / 8 / Stream</small></span></button>
            <button class="os-distro-tab" id="tab-rocky" type="button" role="tab" aria-selected="false" aria-controls="panel-rocky"><img src="/assets/os-logos/rockylinux.svg" alt="Rocky Linux" width="32" height="32" decoding="async"><span><strong>Rocky Linux</strong><small>Confirm in checkout</small></span></button>
            <button class="os-distro-tab" id="tab-fedora" type="button" role="tab" aria-selected="false" aria-controls="panel-fedora"><img src="/assets/os-logos/fedora.svg" alt="Fedora" width="32" height="32" decoding="async"><span><strong>Fedora</strong><small>Confirm in checkout</small></span></button>
            <button class="os-distro-tab" id="tab-freebsd" type="button" role="tab" aria-selected="false" aria-controls="panel-freebsd"><img src="/assets/os-logos/freebsd.svg" alt="FreeBSD" width="32" height="32" decoding="async"><span><strong>FreeBSD</strong><small>Confirm in checkout</small></span></button>
            <button class="os-distro-tab" id="tab-alpine" type="button" role="tab" aria-selected="false" aria-controls="panel-alpine"><img src="/assets/os-logos/alpinelinux.svg" alt="Alpine Linux" width="32" height="32" decoding="async"><span><strong>Alpine Linux</strong><small>Confirm in checkout</small></span></button>
            <button class="os-distro-tab" id="tab-alma" type="button" role="tab" aria-selected="false" aria-controls="panel-alma"><img src="/assets/os-logos/almalinux.svg" alt="AlmaLinux" width="32" height="32" decoding="async"><span><strong>AlmaLinux</strong><small>Confirm in checkout</small></span></button>
          </div>
          <div class="os-distro-panels">
            <article class="os-distro-panel" id="panel-ubuntu" role="tabpanel" aria-labelledby="tab-ubuntu">
              <h3>Ubuntu</h3>
              <div class="os-distro-versions"><span>18.04</span><span>20.04</span><span>22.04</span></div>
              <p>Common for websites, panels, and development stacks.</p>
              <p class="os-confirm-note">Confirm the image in checkout. Do not assume Ubuntu 24.04, AlmaLinux, or Rocky Linux unless checkout shows them.</p>
            </article>
            <article class="os-distro-panel" id="panel-debian" role="tabpanel" aria-labelledby="tab-debian" hidden>
              <h3>Debian</h3>
              <div class="os-distro-versions"><span>10</span><span>11</span></div>
              <p>Use when the stack asks for Debian.</p>
              <p class="os-confirm-note">Confirm the image in checkout.</p>
            </article>
            <article class="os-distro-panel" id="panel-centos" role="tabpanel" aria-labelledby="tab-centos" hidden>
              <h3>CentOS</h3>
              <div class="os-distro-versions"><span>7</span><span>8</span><span>Stream</span></div>
              <p>Use when the stack asks for CentOS.</p>
              <p class="os-confirm-note">Confirm the image in checkout.</p>
            </article>
            <article class="os-distro-panel" id="panel-rocky" role="tabpanel" aria-labelledby="tab-rocky" hidden>
              <h3>Rocky Linux</h3>
              <p>Rocky Linux may be available as an additional image family. Other popular distributions, confirmed in checkout.</p>
              <p class="os-confirm-note">Confirm the exact image and version in checkout before purchasing.</p>
            </article>
            <article class="os-distro-panel" id="panel-fedora" role="tabpanel" aria-labelledby="tab-fedora" hidden>
              <h3>Fedora</h3>
              <p>Fedora may be available as an additional image family. Other popular distributions, confirmed in checkout.</p>
              <p class="os-confirm-note">Confirm the exact image and version in checkout before purchasing.</p>
            </article>
            <article class="os-distro-panel" id="panel-freebsd" role="tabpanel" aria-labelledby="tab-freebsd" hidden>
              <h3>FreeBSD</h3>
              <p>FreeBSD may be available as an additional operating-system image. Confirm in checkout.</p>
              <p class="os-confirm-note">Confirm the exact image and version in checkout before purchasing.</p>
            </article>
            <article class="os-distro-panel" id="panel-alpine" role="tabpanel" aria-labelledby="tab-alpine" hidden>
              <h3>Alpine Linux</h3>
              <p>Alpine Linux may be available as an additional image family. Other popular distributions, confirmed in checkout.</p>
              <p class="os-confirm-note">Confirm the exact image and version in checkout before purchasing.</p>
            </article>
            <article class="os-distro-panel" id="panel-alma" role="tabpanel" aria-labelledby="tab-alma" hidden>
              <h3>AlmaLinux</h3>
              <p>AlmaLinux may be available as an additional image family. Other popular distributions, confirmed in checkout.</p>
              <p class="os-confirm-note">Confirm the exact image and version in checkout before purchasing.</p>
            </article>
          </div>
    ...
    <section class="section os-vps-order" id="order">
      <div class="container">
        ...
        <ol class="os-order-list">
          <li>Write down Ubuntu, Debian, CentOS, or another listed distribution, plus the services you will run.</li>
