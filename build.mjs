...
const WHATSAPP_ICON = '<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M17.472 14.382 c-.297 -.149 -1.758 -.867 -2.03 -.967 -.273 -.099 -.471 -.148 -.67 .15 -.197 .297 -.767 .966 -.94 1.164 -.173 .199 -.347 .223 -.644 .075 -.297 -.15 -1.255 -.463 -2.39 -1.475 -.883 -.788 -1.48 -1.761 -1.653 -2.059 -.173 -.297 -.018 -.458 .13 -.606 .134 -.133 .298 -.347 .446 -.52 .149 -.174 .198 -.298 .298 -.497 .099 -.198 .05 -.371 -.025 -.52 -.075 -.149 -.669 -1.612 -.916 -2.207 -.242 -.579 -.487 -.5 -.669 -.51 -.173 -.008 -.371 -.01 -.57 -.01 -.198 0 -.52 .074 -.792 .372 -.272 .297 -1.04 1.016 -1.04 2.479 0 1.462 1.065 2.875 1.213 3.074 .149 .198 2.096 3.2 5.077 4.487 .709 .306 1.262 .489 1.694 .625 .712 .227 1.36 .195 1.871 .118 .571 -.085 1.758 -.719 2.006 -1.413 .248 -.694 .248 -1.289 .173 -1.413 -.074 -.124 -.272 -.198 -.57 -.347 m-5.421 7.403 h-.004 a9.87 9.87 0 01 -5.031 -1.378 l-.361 -.214 -3.741 .982 .998 -3.648 -.235 -.374 a9.86 9.86 0 01 -1.51 -5.26 c.001 -5.45 4.436 -9.884 9.888 -9.884 2.64 0 5.122 1.03 6.988 2.898 a9.825 9.825 0 012.893 6.994 c-.003 5.45 -4.437 9.884 -9.885 9.884 m8.413 -18.297 A11.815 11.815 0 0012.05 0 C5.495 0 .16 5.335 .157 11.892 c0 2.096 .547 4.142 1.588 5.945 L.057 24 l6.305 -1.654 a11.882 11.882 0 005.683 1.448 h.005 c6.554 0 11.89 -5.335 11.893 -11.893 a11.821 11.821 0 00 -3.48 -8.413 Z"/></svg>';
const ANNOUNCE_OFFER = null;
function announceOfferHtml() {
  if (!ANNOUNCE_OFFER || !ANNOUNCE_OFFER.text) return "";
  const text = String(ANNOUNCE_OFFER.text);
  return ANNOUNCE_OFFER.href
    ? `<a class="announce-offer" href="${ANNOUNCE_OFFER.href}">${text}</a>`
    : `<p class="announce-offer">${text}</p>`;
}
...
function headerHtml(active, { showPalette = true } = {}) {
  return `<header class="header"><div class="announce-bar"><div class="container announce-inner"><a class="whatsapp-desktop" href="${WHATSAPP_URL}" target="_blank" rel="noopener noreferrer"><span class="whatsapp-mark">${WHATSAPP_ICON}</span><span>Message Us On WhatsApp</span></a>${announceOfferHtml()}</div></div><div class="container header-inner">
...
${showPalette ? `      ${paletteLabHtml()}\n` : ""}      <a class="btn btn-sm btn-primary" href="https://dash.stealthrdp.com/index.php?rp=/login">Client Area</a>
  ...
  <a class="whatsapp-mobile" href="${WHATSAPP_URL}" target="_blank" rel="noopener noreferrer" aria-label="Message Us On WhatsApp"><span class="whatsapp-copy">Message Us On WhatsApp</span><span class="whatsapp-mark">${WHATSAPP_ICON}</span></a>`;
}
...
function buildOsVpsPage({
  ...
  const faqSchema = slug === 'windows-vps' ? {
      ...
      "mainEntity": [
        ...
        {"@type": "Question", "name": "Is a Microsoft Windows licence included?", "acceptedAnswer": {"@type": "Answer", "text": "No. Any Microsoft licensing required for the intended use remains the customer's responsibility. Windows Server Evaluation may be provided for evaluation/testing purposes and is Evaluation software, not a permanently licensed Windows installation. Customers may use their own eligible Microsoft licences where permitted by Microsoft's applicable licensing terms."}},
    ...
    <section class="os-vps-faq" id="faq" aria-labelledby="windows-vps-faq-heading">
      <div class="container">
        ...
        <div class="os-vps-faq-grid">
          ...
          <details class="os-vps-faq-item"><summary>Is a Microsoft Windows licence included?</summary><p>No. Any Microsoft licensing required for the intended use remains the customer's responsibility. Windows Server Evaluation may be provided for evaluation/testing purposes and is Evaluation software, not a permanently licensed Windows installation. Customers may use their own eligible Microsoft licences where permitted by Microsoft's applicable licensing terms. Customers are responsible for determining whether their licence is valid for their intended hosted deployment. <a href="${WINDOWS_LICENSING_URL}">Read the Windows licensing page</a>.</p></details>
