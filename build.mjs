...
function headerHtml(active, { showPalette = true } = {}) {
  return `<header class="header"><div class="container whatsapp-slot"><a class="whatsapp-desktop" href="${WHATSAPP_URL}" target="_blank" rel="noopener noreferrer"><span class="whatsapp-mark">${WHATSAPP_ICON}</span><span>Message Us On WhatsApp</span></a></div><div class="container header-inner">
